  ...
  return (
    <div className="eph-mobile-app-shell">
      ...
      {menuOpen && (
        ...
        >
          <aside
            className="flex h-full w-[318px] max-w-[86vw] flex-col overflow-hidden rounded-r-[32px] border-r border-[#DDE7F3] bg-white shadow-[22px_0_54px_rgba(15,23,42,0.22)]"
