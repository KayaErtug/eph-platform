...
// 1) React premium paylaşım kartındaki sol üst kontrol/yetki rozetini kaldır.
...
// 2) İndirilen PNG/Instagram/WhatsApp canvas görselindeki kontrol rozetini kaldır.
...
// 3) Mevcut portföy detayındaki portföy numarasının yanındaki kontrol/doğrulama rozetini kaldır.
...
console.log("- Premium WhatsApp/Instagram kartı: kaldırıldı.");
console.log("- İndirilen PNG/canvas: kaldırıldı.");
console.log("- Portföy detay üst özet kartı: kaldırıldı.");
console.log("Yetki ve doğrulama iş akışları arka planda değişmeden devam eder.");
