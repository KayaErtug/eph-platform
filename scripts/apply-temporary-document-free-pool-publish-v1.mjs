...
// -----------------------------------------------------------------------------
// Backend: aktif üyeliği bulunan portföy sahibi belge/onay beklemeden havuza çıkar.
// -----------------------------------------------------------------------------
...
const directPublishMethod = `  async submitApproval(id: string, user: CurrentUserPayload) {
...
// -----------------------------------------------------------------------------
// Frontend: Belge Merkezi ve yönetici onay blokları görünmez; tek Havuza Gönder.
// -----------------------------------------------------------------------------
...
const frontendSubmitMethod = `  const handleSubmitApproval = async () => {
    if (!unit) return;
...
const poolPublishSection = `        {canEditPortfolio && (
