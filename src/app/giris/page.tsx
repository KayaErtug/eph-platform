...
function StatCard({ label, target, suffix }: { label: string; target: number; suffix: string }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ color: "#475569", fontSize: "9px", marginTop: "2px" }}>{label}</div>
    </div>
  );
}
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 20; i++) {
      ...
      p.style.cssText = `
        ...
        background:rgba(59,130,246,${Math.random() * 0.35 + 0.05});
        border-radius:50%;
        left:${Math.random() * 100}%;
        top:${Math.random() * 100 + 100}%;
        animation:eph-particle ${duration}s linear ${delay}s infinite;
        --dx:${dx}px;
        pointer-events:none;
      `;
...
export default function GirisPage() {
  ...
  return (
    <>
      <style>{`
        @keyframes eph-particle {
          0% { transform: translateY(0) translateX(0); opacity: 0; }
          10% { opacity: 1; }
          90% { opacity: 1; }
          100% { transform: translateY(-700px) translateX(var(--dx)); opacity: 0; }
        }
        @keyframes eph-shimmer {
          0% { background-position: -200% center; }
          100% { background-position: 200% center; }
        }
        @keyframes eph-logoBeat {
          0%, 100% { transform: scale(1); }
          50% { transform: scale(1.06); }
        }
        @keyframes eph-fadeInUp {
        ...
        @keyframes eph-borderGlow {
          0%, 100% { border-color: rgba(37,99,235,0.25); }
          50% { border-color: rgba(37,99,235,0.5); }
        }
        .eph-btn:hover { opacity: 0.9; transform: translateY(-1px); }
        .eph-btn { transition: all 0.2s; }
        .eph-input:focus { border-color: #2563eb !important; outline: none; }
        .eph-eye:hover { color: #94a3b8 !important; }
      `}</style>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            backgroundImage: "url('https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=900&q=80')",
          ...
          <div style={{ position: "relative", zIndex: 2, animation: "eph-fadeInUp 0.5s ease both" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{
                ...
                animation: "eph-logoBeat 4s ease infinite",
              }}>
              ...
              <div>
                <div style={{ color: "#f1f5f9", fontSize: 15, fontWeight: 500, letterSpacing: "-0.2px" }}>EPH Platform</div>
          ...
          <div style={{ position: "relative", zIndex: 2, animation: "eph-fadeInUp 0.7s ease 0.15s both" }}>
            ...
            <div style={{
              ...
              animation: "eph-borderGlow 3s ease infinite",
            }}>
            ...
            <h1 style={{ color: "#f1f5f9", fontSize: 26, fontWeight: 500, lineHeight: 1.25, marginBottom: 10, letterSpacing: "-0.5px" }}>
              ...
              <span style={{
                ...
                animation: "eph-shimmer 3s linear infinite",
              }}>B2B Emlak</span><br />
              Ekosistemi
            </h1>
            ...
            <div style={{
              ...
              <p style={{ color: "#cbd5e1", fontSize: 11, lineHeight: 1.6, marginBottom: 8 }}>
                &ldquo;{t.text}&rdquo;
              </p>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div style={{
                  ...
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 10, color: "white", fontWeight: 500, flexShrink: 0,
                }}>
                  {t.initials}
                </div>
                <div>
              ...
              <div style={{ display: "flex", justifyContent: "center", gap: 4, marginTop: 8 }}>
                {testimonials.map((_, i) => (
                  <div key={i} style={{
                    width: i === testimonialIdx ? 16 : 5,
                    height: 5, borderRadius: 3,
                    background: i === testimonialIdx ? "#3b82f6" : "rgba(255,255,255,0.15)",
                    transition: "all 0.3s",
                    cursor: "pointer",
        ...
        <div style={{
          ...
          <div style={{ width: "100%", maxWidth: 300, animation: "eph-fadeInUp 0.7s ease 0.3s both" }}>
            ...
            <form onSubmit={handleSubmit(onSubmit)} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {/* Email */}
              <div>
                <label style={{ display: "block", color: "#64748b", fontSize: 11, fontWeight: 500, marginBottom: 5 }}>
                  Email adresi
                </label>
                <div style={{ position: "relative" }}>
                  <svg style={{ position: "absolute", left: 11, top: "50%", transform: "translateY(-50%)" }} width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2">
                  ...
                  <input
                    ...
                    style={{
                      ...
                      fontSize: 12, background: "#f8fafc", color: "#0f172a",
            ...
            <p style={{ textAlign: "center", color: "#64748b", fontSize: 11, marginBottom: 16 }}>
              Hesabınız yok mu?{" "}
              <Link href="/kayit" style={{ color: "#2563eb", textDecoration: "none", fontWeight: 500 }}>
                Kayıt olun
              </Link>
            </p>
            ...
            <div style={{ background: "#f8fafc", border: "0.5px solid #e2e8f0", borderRadius: 8, padding: 10, display: "flex", gap: 8, alignItems: "flex-start" }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#2563eb" strokeWidth="2" style={{ flexShrink: 0, marginTop: 1 }}>
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
              </svg>
              <p style={{ color: "#94a3b8", fontSize: 10, lineHeight: 1.6, margin: 0 }}>
                Yalnızca davet koduyla erişilebilir. Referans için mevcut bir üyeyle iletişime geçin.
              </p>
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 16, marginTop: 16 }}>
              {[
                ...
                { icon: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75M9 7a4 4 0 1 1 0 8 4 4 0 0 1 0-8z", label: "Davetli" },
                { icon: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z", label: "7/24 Aktif" },
              ].map((item, i) => (
